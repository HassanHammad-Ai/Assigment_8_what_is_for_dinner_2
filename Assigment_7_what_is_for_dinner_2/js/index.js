...
var mealRatingAverage = document.getElementById("ratingAverage");
var mealRatingQuantity = document.getElementById("ratingQuantity");
var mealLevel = document.getElementById("level");
var mealCategory = document.getElementById("category");
var mealName = document.getElementById("name");
var mealDescription = document.getElementById("description");
var mealPrepTime = document.getElementById("prepTime");
var mealCookTime = document.getElementById("cookTime");
var mealServings = document.getElementById("servings");
var mealIngredients = document.getElementById("ingredients");
var mealCalories = document.getElementById("calories");
var mealCarbohydrates = document.getElementById("carbohydrates");
var mealFat = document.getElementById("fat");
var mealFiber = document.getElementById("fiber");
var mealSodium = document.getElementById("sodium");
var mealProtien = document.getElementById("protien");
var mealInstructions = document.getElementById("instructions");
var mealChefTips = document.getElementById("chefTips");

var meals = [
  {
    name: "Thai Green Curry",
    imageUrl: "http://127.0.0.1:5500/images/meal19.jpg",
  ...
  {
    name: "Pad Thai",
    imageUrl: "http://127.0.0.1:5500/images/meal6.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal8.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal15.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal4.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal14.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal12.jpg",
  ...
  {
    name: "Beef Tacos",
    imageUrl: "http://127.0.0.1:5500/images/meal13.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal16.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal5.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal18.jpg",
  ...
  {
    name: "Caesar Salad",
    imageUrl: "http://127.0.0.1:5500/images/meal1.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal10.jpg",
  ...
  {
    name: "Shrimp Scampi",
    imageUrl: "http://127.0.0.1:5500/images/meal11.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal17.jpg",
  ...
  {
    name: "Greek Moussaka",
    imageUrl: "http://127.0.0.1:5500/images/meal3.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal7.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal9.jpg",
  ...
  },
  {
    ...
    imageUrl: "http://127.0.0.1:5500/images/meal2.jpg",
...
var shownMeals = []; // Array to keep track of all meals that have been shown

function anotherMeal() {
  var randomIndex;
  var meal;

  // If all meals have been shown, reset the array
  if (shownMeals.length === meals.length) {
    shownMeals = [];
    alert("You've seen all meals! Starting over."); // Optional message
  }

  // Keep generating random meals until we get one that hasn't been shown
  do {
    randomIndex = Math.trunc(Math.random() * meals.length);
    meal = meals[randomIndex];
  } while (shownMeals.includes(meal.name));

  // Add this meal to the shown meals array
  shownMeals.push(meal.name);

  // get a random meal from the array
  // var randomIndex = Math.trunc(Math.random() * meals.length);
  ...
  mealRatingAverage.innerHTML = meal.ratingsAverage;

  // update ratingQuantity
  mealRatingQuantity.innerHTML = `(${meal.ratingsQuantity} reviews)`;

  // update name of meal
  mealName.innerHTML = meal.name;

  //update description of the meal
  mealDescription.innerHTML = meal.description;

  //update category of meal
  mealCategory.innerHTML = meal.category;

  //update level of meal
  mealLevel.innerHTML = meal.level;

  //update prep time of meal
  mealPrepTime.innerHTML = `${meal.prepTime} min`;

  //update cook time of meal
  mealCookTime.innerHTML = `${meal.cookTime} min`;

  //update servings of meal
  mealServings.innerHTML = `${meal.servings} people`;

  // show or hide warning for a long prep time
  var warningMessage = document.getElementById("warning");
  if (meal.prepTime + meal.cookTime > 45) {
    warningMessage.classList.remove("d-none");
  } else {
    warningMessage.classList.add("d-none");
  }

  // update the Ingredients of the meal
  // note for me hassan this for trick used for only arrays of the object is array
  var ingredientList = "";
  for (var i = 0; i < meal.ingredients.length; i++) {
    ingredientList += ` <li class="d-flex align-items-center gap-2">
                            <div
                              class="number rounded-circle d-flex align-items-center justify-content-center text-white fw-bold me-2 mt-1"
                            >
                              ${i + 1}
                            </div>
  ...
  mealIngredients.innerHTML = ingredientList;

  // update instructions of meal
  var instructionList = "";
  for (var i = 0; i < meal.instructions.length; i++) {
    instructionList += `<li class="d-flex align-items-center gap-2">
                            <div
                              class="number rounded-4 d-flex align-items-center justify-content-center text-white fw-bold me-2 mt-1 fs-5 white-space-nowrap flex-shrink-0"
                            >
                              ${i + 1}
                            </div>
                            <span
  ...
  mealInstructions.innerHTML = instructionList;

  // update nutrition for the meal
  //calories
  mealCalories.innerHTML = `${meal.nutrition.calories} kcal`;
  //carbohydrates
  mealCarbohydrates.innerHTML = `${meal.nutrition.carbohydrates} g`;
  //protien
  mealProtien.innerHTML = `${meal.nutrition.protein} g`;
  //fat
  mealFat.innerHTML = `${meal.nutrition.fat} g`;
  //fiber
  mealFiber.innerHTML = `${meal.nutrition.fiber} g`;
  //sodium
  mealSodium.innerHTML = `${meal.nutrition.sodium} mg`;

  // update chef tips for meal
  var chefTipsList = "";
  for (var i = 0; i < meal.chefTips.length; i++) {
    chefTipsList += ` <div class="col-12">
                            <div
                              class="horizontal first-row rounded-4 p-3 d-flex align-items-center gap-3"
                            >
                              <div
                              ...
                              <p style="color: oklch(0.373 0.034 259.733)">
                               ${meal.chefTips[i]}
                              </p>
                            </div>
                          </div>`;
  ...
  mealChefTips.innerHTML = chefTipsList;
}
